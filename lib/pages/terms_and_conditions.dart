          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                Paragraph(
                  "These Legal Terms shall be governed by and defined following the laws of England and Wales. The Gift Vault and yourself irrevocably consent that the courts of England and Wales shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.",
                ),
                ...
                SizedBox(height: 20),
                Paragraph(
                  'Binding Arbitration\n\nAny dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be 2. The seat, or legal place, or arbitration shall be London. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of England and Wales.',
                ),
                SizedBox(height: 20),
                Paragraph(
                ...
                SectionTitle('19. SHIPPING POLICY'),
                SizedBox(height: 10),
                Paragraph(
                  "Shipping times and costs may vary depending on the item purchased, its size, weight, availability, and destination. Estimated delivery times will be provided at checkout, and we aim to dispatch all orders as promptly as possible. Once your order is placed, you will receive a confirmation email with tracking details (where available) sent to the contact information you provide at checkout. We will communicate any updates, delays, or issues related to your shipment using this contact information. It is your responsibility to ensure all shipping details are accurate and complete. We are not liable for delivery issues arising from incorrect or incomplete address information. Risk of loss and title for items purchased pass to you upon our delivery to the carrier. If any customs duties, taxes, or import charges apply, these are the responsibility of the recipient unless otherwise stated.",
                ),
                SizedBox(height: 30),
